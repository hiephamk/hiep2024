...
return array(
    'title'      =>__( '404 Page', 'luxury-watches' ),
...
<p class="has-text-align-center has-content-heading-font-size"><strong>'. esc_html('Unfortunately we can’t find that page.','luxury-watches') .'</strong></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">'. esc_html('The page you are looking for doesnt exist or has been moved. Try another url or go to the site homepage.','luxury-watches') .'</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->',
);